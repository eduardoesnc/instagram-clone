                ...
                <div onClick={()=>fecharModalCriar()} className="close-modal-criar">X</div>
                  <h2>Criar Conta</h2>
                    <form onSubmit={(e)=>criarConta(e)}>
                        <input id="email-cadastro" type="text" placeholder="Digite seu e-mail" />
                        <input id="username-cadastro" type="text" placeholder="Digite seu username" />
                ...
                <div onClick={()=>fecharModalUpload()} className="close-modal-criar">X</div>
                  <h2>Fazer Upload</h2>
                    <form  id="form-upload" onSubmit={(e)=>uploadPost(e)}>
                        ...
                        <input id="titulo-upload" type="text" placeholder="Legenda da sua foto" />
